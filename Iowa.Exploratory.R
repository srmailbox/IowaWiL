      ...
      , parameterEstimates(exp.gr46.CC2irr.SEM) %>% 
        mutate(
          rhs=
            factor(
              rhs
              , levels = paste(gl(3,3,labels=c("CC2irr", "Fi", "Fsbr")), 4:6, sep="_")
              , labels=paste(gl(3,3,labels=c("CC2irr", "Fi", "Fsbr")), 1:3, sep="_")
            )
          , lhs=
            factor(
              lhs
      ...
      , parameterEstimates(exp.gr46.CC2nw.SEM) %>% 
        mutate(
          rhs=
            factor(
              rhs
              , levels = paste(gl(3,3,labels=c("CC2nw", "Fi", "Fsbr")), 4:6, sep="_")
              , labels=paste(gl(3,3,labels=c("CC2nw", "Fi", "Fsbr")), 1:3, sep="_")
            )
          , lhs=
            factor(
              lhs
